...
export type AgentFixIntent =
  ...
  | { kind: 'rescan' }
  /**
   * Prompt the user to point AIWP Design at an explicit binary by writing
...
export type AgentDiagnosticReason =
  ...
  /** The installed CLI version is outside this AIWP Design build's tested set. */
  | 'untested-version'
...
export interface AgentInfo {
  ...
  /** Whether models came from the installed CLI or AIWP Design's static fallback. */
