...
const AUTHORING_DEFAULT_SCENARIO_INPUTS = {
  artifactKind: 'AIWP Design plugin',
  audience: 'AIWP Design plugin authors',
  topic: 'packaging a reusable workflow as an AIWP Design plugin',
};
...
export function HomeView({
  ...
  async function handlePickWorkingDir() {
    ...
    if (isOpenDesignHostAvailable()) {
      ...
      setError(
        `Couldn't open the folder picker (${'reason' in result ? result.reason : 'host unavailable'}). Please update AIWP Design and try again.`,
      );
      return null;
    }
