...
interface Props {
  ...
  /** AIWP Design Cloud profile from the blocking snapshot; picks the console origin. */
  profile: string | null;
...
// HARD pre-run blocker for AIWP Design Cloud tasks: the run cannot possibly
...
//
//   signed_out — AIWP Design Cloud selected but no account session. The CTA
...
export function AmrBalanceDialog({
  ...
  const openUpgrade = () => {
    ...
    // Same attribution handshake as the other AIWP Design Cloud handoffs
