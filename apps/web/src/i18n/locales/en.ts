...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to AIWP Design Cloud — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrCard.switchCta': 'Switch to AIWP Design Cloud & retry',
  'chat.amrError.authMessage': 'Your AIWP Design Cloud account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your AIWP Design Cloud allowance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with AIWP Design Cloud',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the AIWP Design Cloud agent — sign in and this task can start right away.',
  ...
  'chat.runError.signInMessage.amr': 'The AIWP Design Cloud agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the AIWP Design Cloud agent — steadier and better value.',
  ...
  'chat.runError.cpuUnsupportedMessage': "This agent's runtime needs a CPU instruction set (AVX2) that this device doesn't have, so it can't start. Update AIWP Design to the latest version, which ships a compatible runtime.",
  'chat.runError.cliSessionRefusedMessage':
    "{agent} refused to start a session. The installed version is usually incompatible with AIWP Design — switch to a different version and retry.",
  ...
  'settings.welcomeTitle': 'Welcome to AIWP Design',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. AIWP Design will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. AIWP Design reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingExecutionBody': 'Use the AIWP Design hosted service, connect a local coding agent, or bring your own model key.',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to AIWP Design Cloud to continue.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the AIWP Design daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to AIWP Design.',
  ...
  'settings.amrAccountStatus': 'AIWP Design Cloud account status',
  ...
  'settings.mcpServerHint': 'Expose AIWP Design as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the AIWP Design team',
  'settings.privacyConsentKicker': 'Help us improve AIWP Design',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how AIWP Design performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time AIWP Design starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but AIWP Design could not quit automatically.',
  ...
  'settings.mcpTitle': 'Connect AIWP Design to your coding agent',
  'settings.mcpHint': 'Use MCP to give supported agents access to your projects and design context.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure AIWP Design is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Use the project and file currently open in AIWP Design as context.',
  'settings.mcpRunningNote': 'Keep AIWP Design running. Restart your coding agent after setup.',
  ...
  'entry.discordAria': 'Join the AIWP Design Discord',
  'entry.discordAriaWithOnline': 'Join the AIWP Design Discord - {online}',
  'entry.discordOnlineLabel': '{count} online',
  'entry.mailAria': 'Email AIWP Design',
  ...
  'entry.followXLabel': 'Follow @SMBTeam on X',
  ...
  'entry.followLinkedinLabel': 'Follow AIWP Design on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow AIWP Design on Xiaohongshu',
  ...
  "entry.cloudCalloutBody": "Sign in to use AIWP Design Cloud and collaborate in the cloud",
  "entry.cloudCalloutDismissAria": "Dismiss AIWP Design Cloud note",
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable AIWP Design plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit AIWP Design Cloud',
  ...
  'handoff.promptIntro': 'Continue from this local AIWP Design project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. AIWP Design Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use AIWP Design workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with AIWP Design and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to AIWP Design',
  'pluginCard.contributeTitle': 'Contribute plugin to AIWP Design with a pull request',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use AIWP Design from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure AIWP Design is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use AIWP Design everywhere',
  'useEverywhere.modalTitle': 'Use AIWP Design everywhere',
  'useEverywhere.modalSubtitle': 'Drop AIWP Design into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'AIWP Design works wherever your agent works',
  'useEverywhere.section.overview.intro': 'AIWP Design is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires AIWP Design as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without AIWP Design at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive AIWP Design from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose AIWP Design as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'AIWP Design ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover AIWP Design tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the AIWP Design app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without AIWP Design running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). AIWP Design extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside AIWP Design and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + AIWP Design extras)',
  ...
  'entry.githubStarAria': 'Star AIWP Design on GitHub',
  ...
  'newproj.locationDefault': 'AIWP Design projects',
  ...
  'avatar.amrConsole': 'AIWP Design Cloud',
  ...
  'socialShare.openDesignSection': 'Share AIWP Design',
  'socialShare.openDesignTitle': 'AIWP Design on GitHub',
  'socialShare.openDesignText': 'AIWP Design is a source-available workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with AIWP Design: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with AIWP Design: {title}\n{url}\nAIWP Design repo: {repo}',
  ...
  'brandEnrichment.body': "AIWP Design will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask AIWP Design to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want AIWP Design to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure AIWP Design is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying AIWP Design? Star us on GitHub.',
  'designFiles.usefulInfoTip8': 'Follow @SMBTeam on X for the latest updates.',
  ...
  'designFiles.usefulInfoTip18': 'Subscribe to AIWP Design on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow AIWP Design on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow AIWP Design on Xiaohongshu for tips and inspiration.',
  ...
  'fileViewer.publishFileRequiresWorkspace': 'A share link needs a signed-in workspace. Sign in to AIWP Design Cloud, or use a deploy option to share this file.',
  ...
  'assistant.shareToOpenDesign': 'Share to AIWP Design',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with AIWP Design — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with AIWP Design — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple AIWP Design project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.customInstructionsHint': 'Fixed instructions AIWP Design should follow in every chat. Save facts, preferences, and project context as memories.',
  ...
  'updater.availableBody': 'AIWP Design {version} is available. It will download before the installer can open.',
  'updater.activeRunsTitle': 'AIWP Design is still working',
  'updater.activeRunsBody': '{count} active tasks are still running. Restarting now will interrupt them.',
  'updater.activeRunsUnknownBody': 'AIWP Design could not confirm whether tasks are still running. Restarting now may interrupt active work.',
  ...
  'updater.installerOpenBody': 'The installer is open. AIWP Design is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit AIWP Design',
  'updater.quitFailedBody': 'The installer is open, but AIWP Design could not quit. Quit AIWP Design before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. AIWP Design will close and open the installer.',
  'updater.readyVersion': 'AIWP Design {version} is ready. AIWP Design will close and open the installer.',
  'updater.reinstallLearnMore': 'Learn more',
  'updater.reinstallReadyGeneric': 'This update requires a full reinstall. AIWP Design will close and open the installer.',
  'updater.reinstallReadyVersion': 'AIWP Design {version} requires a full reinstall. AIWP Design will close and open the installer.',
  ...
  'whatsNew.updatedTitle': 'AIWP Design {version} is here',
  ...
  'dsManager.createBody': 'Teach AIWP Design your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions AIWP Design follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach AIWP Design your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'AIWP Design turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
  ...
  'campaign.deepseekV4Flash.ruleSummary': 'From Aug 13–27, paid users can use DeepSeek V4 Pro and V4 Flash for free in AIWP Design. Large-scale abuse may pause campaign access.',
  'campaign.deepseekV4Flash.windowLabel': 'Aug 13–27',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'two weeks free',
  'campaign.deepseekV4Flash.boundary': 'Unlimited model quota and free generation counts in your plan apply only inside AIWP Design — not via MCP, CLI, API, or other surfaces. Final interpretation rests with AIWP Design. Some models may need to queue at peak hours.',
  ...
  'experienceSurvey.tag': "We'd love your feedback — help improve AIWP Design",
  'experienceSurvey.close': "Close",
  'experienceSurvey.recommendation': "How likely are you to recommend AIWP Design to a colleague or friend?",
  ...
  'labs.harnessHint': "Your next generation will use AIWP Design's latest strategy, with noticeably more polished results (beta)",
  'labs.harnessTooltip': "Switches to the agent harness AIWP Design built for design work. Output is noticeably better in layout, structure, and completeness.",
