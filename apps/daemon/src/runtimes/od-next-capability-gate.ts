...
/**
 * Exact Codex 0.147.0 tuple replayed by AIWP Design against the installed CLI
...
/**
 * AIWP Design-owned best-effort replay for the exact native OpenCode tuple.
...
/**
 * AIWP Design-owned replay of the exact Claude 2.1.233 Agent stream-json
