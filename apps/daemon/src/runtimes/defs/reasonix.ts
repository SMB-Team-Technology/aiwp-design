...
// REASONIX_ACP_SYSTEM_APPEND. This ensures the model follows AIWP Design's
// design workflow (artifact output, design system, skill instructions)
// instead of treating every request as a pure coding task.
const DESIGN_INSTRUCTIONS = `# AIWP Design integration — MUST follow

You are running inside AIWP Design, a design tool. The user message contains
