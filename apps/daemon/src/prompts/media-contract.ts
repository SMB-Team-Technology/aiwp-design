...
AIWP Design-owned media execution is **disabled for this run**. Do not call
...
AIWP Design Cloud image and video models use the \`vela/*\` catalogue prefix.
...
**Default recipe — use AIWP Design's scaffold, don't write from scratch.**
...
# AIWP Design writes the required files itself; HyperFrames init is never run.
