...
export const MEDIA_PROVIDERS: MediaProvider[] = [
  ...
  { id: 'vela', label: 'AIWP Design Cloud', hint: 'Managed image and video generation through Vela', integrated: true, credentialsRequired: false, settingsVisible: false },
...
export const IMAGE_MODELS: MediaModel[] = [
  ...
  { id: 'vela/seedream-5.0-pro', label: 'seedream-5.0-pro (Cloud)', hint: 'AIWP Design Cloud · high-quality managed image generation and editing', provider: 'vela', caps: ['t2i', 'i2i'] },
