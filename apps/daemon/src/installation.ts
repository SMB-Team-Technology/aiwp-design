...
// Locations:
//
//   packaged (mac):    ~/Library/Application Support/AIWP Design Prerelease/installation.json
//   packaged (win):    %APPDATA%/AIWP Design Prerelease/installation.json
//   packaged (linux):  $XDG_CONFIG_HOME/AIWP Design Prerelease/installation.json
