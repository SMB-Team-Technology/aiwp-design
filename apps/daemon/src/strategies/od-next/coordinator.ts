 ...
 * ran the frozen plan, delivered a canonical entry AIWP Design resolved itself,
...
export function odNextTurnMayInferProductionCompletion(
  ...
  return task.inputStage === 'production'
    ...
    // Simple only. The inference rests on AIWP Design having resolved the
 ...
 * by evidence AIWP Design resolved itself, which is stronger than the agent's
