  ...
  return {
    ...
    platforms: {
      mac: {
        arch: "arm64",
        artifacts: {
          dmg: artifact("AIWP Design.dmg"),
          zip: artifact("AIWP Design-mac-arm64.zip"),
        },
        enabled: true,
        signed: true,
      },
      macIntel: {
        arch: "x64",
        artifacts: {
          dmg: artifact("AIWP Design Intel.dmg"),
          zip: artifact("AIWP Design-mac-x64.zip"),
        },
        enabled: true,
        signed: true,
      },
      win: {
        arch: "x64",
        artifacts: {
          installer: artifact("AIWP Design Setup.exe"),
        },
        enabled: true,
      },
    },
